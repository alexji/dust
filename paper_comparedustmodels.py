...
##                   'M-D-20', 'M-ND-20', 'M-D-170', 'M-ND-170']
    ...
    ax.plot(ind,x55_Td,'s-',color='r',alpha=0.6)
    ax.plot(ind,std_Td,'D-',color='g',alpha=0.6)
    ...
    ax.plot(ind,x55_kP,'s-',color='r',alpha=0.6)
    ax.plot(ind,std_kP,'D-',color='g',alpha=0.6)
    ...
    ax.plot(ind,x55_S,'s-',color='r',alpha=0.6)
    ax.plot(ind,std_S,'D-',color='g',alpha=0.6)
    ...
    ax.plot(ind,x55_Dc,'s-',color='r',alpha=0.6)
    ax.plot(ind,std_Dc,'D-',color='g',alpha=0.6)
