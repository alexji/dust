...
def plot_ntplane(dustmodel,dust_opacity=False):
    ...
    plt.imshow(-1*Dcrit.transpose(),extent=(0,20,1.5,3.5),origin='lower',aspect=8.0)
    plt.colorbar(shrink=0.8)#,ticks=[-15,-12,-9,-6,-3,0,3,6,8])
    ...
    plt.ylim((1.5,3.5))
    if dust_opacity:
        plt.savefig("PLOTS/"+dustmodel+"_Dcritplane_dustopacity.pdf")
    else:
        plt.savefig("PLOTS/"+dustmodel+"_Dcritplane.pdf")
    ...
    plt.ylim((1.5,3.5))
    if dust_opacity:
        plt.savefig("PLOTS/"+dustmodel+"_Tdplane_dustopacity.pdf")
    else:
        plt.savefig("PLOTS/"+dustmodel+"_Tdplane.pdf")
